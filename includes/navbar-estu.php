...
<head>
    ...
    <link href="/skillboots/assets/css/notificacion.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="container-fluid d-none d-lg-block">
        <div class="nav-bar row align-items-center py-4 px-xl-5" style="flex-wrap: nowrap;">
            ...
            <div class="derecho">
                            <a href="/skillboots/index.php" class="nav-item nav-link active" style="color:#ff6600; ">Inicio</a>
    ...
    <!-- Estado de carga -->
    <div class="dropdown-item loading">Cargando notificaciones...</div>
    
    <!-- Ejemplo de notificación -->
    <div class="dropdown-item notification-item">
        <div class="notification-title">Título de la notificación</div>
        <div class="notification-content">
            Este es el contenido de la notificación que puede ser bastante largo y se ajustará automáticamente sin cortarse.
        </div>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="user-info justify-content-center">
                        ...
                        <a href="/skillboots/index.php" class="nav-item nav-link">Inicio</a>
                        ...
                        <a href="/skillboots/templates/contact.php" class="nav-item nav-link">Contáctanos</a>
                    </div>
                </div>
            </nav>
        </div>
...
<script src="/skillboots/assets/js/notificaciones.js"></script>
