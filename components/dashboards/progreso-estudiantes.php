...
<?php
include './AbooutCourses/Extrae.php';
?>
<script>
    ...
    function mostrarDetalleCurso(cursoId) {
        ...
        continueBtn.onclick = function() {
            // Aquí se implementaría la redirección al curso
            alert(`Redirigiendo al curso: ${curso.titulo}`);
            // En un entorno real, redirigirías a la URL del curso
